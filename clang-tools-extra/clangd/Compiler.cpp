...
void disableUnsupportedOptions(CompilerInvocation &CI) {
  ...
  CI.getMutLangOpts().NoSanitizeFiles.clear();
  CI.getMutLangOpts().XRayAttrListFiles.clear();
  CI.getMutLangOpts().ProfileListFiles.clear();
  CI.getMutLangOpts().XRayAlwaysInstrumentFiles.clear();
  CI.getMutLangOpts().XRayNeverInstrumentFiles.clear();
}
