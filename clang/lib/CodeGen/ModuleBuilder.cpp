...
namespace {
  ...
  public:
    CodeGeneratorImpl(DiagnosticsEngine &diags, llvm::StringRef ModuleName,
                      ...
                      const PreprocessorOptions &PPO, const CodeGenOptions &CGO, const DebugOptions &DO,
                      llvm::LLVMContext &C,
                      CoverageSourceInfo *CoverageInfo = nullptr)
        : Diags(diags), Ctx(nullptr), FS(std::move(FS)), HeaderSearchOpts(HSO),
          PreprocessorOpts(PPO), CodeGenOpts(CGO), DebugOpts(DO), HandlingTopLevelDecls(0),
...
clang::CreateLLVMCodeGen(DiagnosticsEngine &Diags, llvm::StringRef ModuleName,
                         ...
                         const CodeGenOptions &CGO, const DebugOptions &DO, llvm::LLVMContext &C,
                         CoverageSourceInfo *CoverageInfo) {
